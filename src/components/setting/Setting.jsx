        ...
        <>
            ...
            <div className="setting-container">
                <div className="card-design">
                    ...
                    <div className="theme-container">
                        {themes.map(color =>
                            <div className="grid-color" onClick={() => handleClick(color.name, color.className)}>
                                <div className={`color-container ${color.className} ${selectedColor === color.name ? 'border-applied' : ''}`}>
                                    <div className="left-two-circles">
                                        <div className="circle-overlap-one"></div>
                                        <div className="circle-overlap-two"></div>
                                    </div>
                                    <div className="inside-box">
                                        <div className="headerclass">
                                            <div className="left-header">
                                                <div className="semi-bar"></div>
                                        ...
                                        <div className="semi-bar-short-straight"></div>
                                        <div className="semi-bar-straight"></div>

                                        <div className="semi-box"></div>
                                        <div className="space-class"></div>
                                        <div className="circle-semi">
                                            <div className="circle-bar"></div>
                                            <div className="semi-bar-circle"></div>
                                        </div>
                    ...
                    <div>
                        <p className='setting-head'>Application Language</p>
                        <p className='language-sub'>Language applied to the entire application, only English has silly stuff 🙁.</p>
