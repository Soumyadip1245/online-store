...
const storeConfig = {
  apiKey: import.meta.env.VITE_APP_STORE_FIREBASE_API_KEY,
  authDomain: import.meta.env.VITE_APP_STORE_FIREBASE_AUTH_DOMAIN,
  projectId: import.meta.env.VITE_APP_STORE_FIREBASE_PROJECT_ID,
  storageBucket: import.meta.env.VITE_APP_STORE_FIREBASE_STORAGE_BUCKET,
  messagingSenderId: import.meta.env.VITE_APP_STORE_FIREBASE_MESSAGING_SENDER_ID,
  appId: import.meta.env.VITE_APP_STORE_FIREBASE_APP_ID,
}
...
const client = new Client().setEndpoint(import.meta.env.VITE_APP_APPWRITE_ENDPOINT).setProject(import.meta.env.VITE_APP_APPWRITE_PROJECT)
...
class FirebaseService {
  ...
  getInvoice(fileId) {
    ...
    const result = storage.getFileDownload(import.meta.env.VITE_APP_APPWRITE_STORAGE, fileId)
    return result
  }
  ...
  async uploadPDF(file, orderNumber) {
    ...
    const result = await storage.createFile(import.meta.env.VITE_APP_APPWRITE_STORAGE, uniqueName, fileBlob)
